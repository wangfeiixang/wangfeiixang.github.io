...
var turntable ={
    ...
    ajax:function(){//第一次请求数据
        var that = this;
        $.ajax({
            url: basePath + "/queryUserluckyDrawStatus",
            dataType: "json",
            type:"post",
            async:false,
            data:{
    ...
    searchResult:function(type){//刚进页面就进行抽奖查询
        // console.log('查询结果')
        var that = this;
        var url = basePath + '/getqueryLuckyDrawResult';
        $.ajax({
            url: url,
            dataType: "json",
            type:"post",
            ...
            success: function(data) {
                ...
                if( data.resultCode=="OK" ) {
                    ...
                    // console.log(data.luckyDrawResult)
    ...
    inform:function(){
        $.ajax({
            url: basePath + "/clubberReceiveLuckyDraw",
            dataType: "json",
            // async:false,
            data:{
            },
...
var personRecord = {
    ...
    acceptData:function(url){
        var that = this;
        $.ajax({
            url: basePath+"/getCurrentUserRecord",
            dataType: "json",
            type:"post",
            async:false,
            data:{
...
var prize ={
    ...
    ajax:function(type){//请求数据方法
        var that = this;

        $.ajax({
            url: basePath+"/getWinningRecord",
            dataType: "json",
            async:false,
            type:"post",
            data:{
